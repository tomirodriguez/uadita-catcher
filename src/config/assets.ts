...
/**
 * Background images for level progression.
 * Changes every 3 levels.
 */
export const BACKGROUND_IMAGES = [
	"/images/background_1.jpeg", // Levels 1-3
...
export const GOOD_ITEMS = [
	{
		path: "/images/good_1.png",
		width: 64,
		height: 64,
		points: 10,
		hitbox: { width: 44, height: 44, offsetX: 10, offsetY: 10 },
	},
	{
		path: "/images/good_2.png",
		width: 64,
		height: 64,
		points: 10,
		hitbox: { width: 44, height: 44, offsetX: 10, offsetY: 10 },
